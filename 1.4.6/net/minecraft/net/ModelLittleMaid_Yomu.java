...
public class ModelLittleMaid_Yomu extends LMM_ModelLittleMaid_Archetype {
	...
	public void setLivingAnimationsLM(LMM_EntityLittleMaid entityliving, float f, float f1, float f2)
	{
		...
		if (entityliving instanceof LMM_EntityLittleMaid) {
			...
			float f3 = (float)entityliving.ticksExisted + t + entitylittlemaid.entityIdFactor;
...
/*				if(entitylittlemaid.entityId==180){
	...
	public void setRotationAnglesLM(float f, float f1, float f2, float f3, float f4, float f5,LMM_EntityLittleMaid maid)
	{
